<?php // http://shinraholdings.com/621/custom-walker-to-extend-the-walker_comment-class/
...
class lsvr_walker_comment extends Walker_Comment {
    ...
    function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
        ...
        <li <?php comment_class( $parent_class ); ?> id="comment-<?php comment_ID() ?>">
			...
			<div class="comment-inner<?php if ( get_avatar( $comment ) ){ echo ' has-portrait'; } ?>">
				...
				<div id="comment-content-<?php comment_ID(); ?>" class="comment-content various-content">
					<?php if( !$comment->comment_approved ) : ?>
						<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation', 'lsvrtheme' ); ?> </em>
				...
				<div class="comment-info">
					...
					<?php edit_comment_link( __( 'Edit', 'lsvrtheme' ), '<div class="comment-edit">', '</div>' ); ?>
				</div>
			</div>
