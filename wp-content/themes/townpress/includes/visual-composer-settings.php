...
if ( is_plugin_active( 'js_composer/js_composer.php' ) ) {
	...
	$dir = get_template_directory() . '/components/visualcomposer/layouts';
	...
	if ( ! function_exists( 'lsvr_vc_modify_layout_templates' ) ) {
		function lsvr_vc_modify_layout_templates( $data ) {
			...
			$custom_layout_id_arr = array( 'front-page-1', 'front-page-2', 'town-hall', 'town-council', 'phone-numbers', 'write-to-mayor',
				'statistics', 'virtual-tour', 'town-history', 'bbpress-lost-password', 'bbpress-login-register' );
