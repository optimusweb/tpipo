...
class Lsvr_Events_Widget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        $instance = wp_parse_args( (array) $instance, array( 'title' => __( 'Events', 'lsvrtoolkit' ),
			'category' => 'none', 'limit' => 5, 'show_date' => 'on', 'show_excerpt' => 'on', 'show_all_btn_label' => __( 'See All Events', 'lsvrtoolkit' ) ) );
		...
		<?php $terms_arr = get_terms( 'lsvreventcat' ); ?>
    ...
    function widget( $args, $instance ) {
		...
		<?php echo $before_widget; ?>
            ...
            <div class="widget-content">
				...
				if ( $category !== 'none' ) {
					$q_args[ 'tax_query' ] = array( array( 'taxonomy' => 'lsvreventcat', 'field' => 'id', 'terms' => array( intval( $category ) ) ) );
				}
				...
				<?php if ( $loop->have_posts() ) : ?>
					...
					<?php if ( $show_all_btn_label !== '' ) : ?>
						<?php $show_all_btn_link = $category !== 'none' ? get_term_link( intval( $category ), 'lsvreventcat' ) : get_post_type_archive_link( 'lsvrevent' ); ?>
