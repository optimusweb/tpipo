...
class Lsvr_Image_Widget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        $instance = wp_parse_args( (array) $instance, array( 'title' => '', 'image_id' => '', 'image_size' => '', 'image_link' => '', 'link_target_blank' => 'off' ) );
		...
		<p>
			<input class="checkbox" type="checkbox" id="<?php echo $this->get_field_id( 'link_target_blank' ); ?>" name="<?php echo $this->get_field_name( 'link_target_blank' ); ?>" <?php if ( isset( $link_target_blank ) && $link_target_blank === 'on' ) { echo ' checked'; } ?>>
            <label for="<?php echo $this->get_field_id( 'link_target_blank' ); ?>"><?php echo __( 'Open Link in New Tab', 'lsvrtoolkit' ); ?></label>
        </p>
    ...
    function update( $new_instance, $old_instance ) {
		...
		$instance['link_target_blank'] = $new_instance['link_target_blank'];
        return $instance;
    ...
    function widget( $args, $instance ) {
		...
		$link_target = array_key_exists( 'link_target_blank', $instance ) && $instance['link_target_blank'] === 'on' ? ' target="_blank"' : '';
		...
		<?php echo $before_widget; ?>
            ...
            <div class="widget-content">
				...
				<?php if ( $image_data ) : ?>
					...
					<?php if ( $image_link !== '' ) : ?>
						<a href="<?php echo esc_url( $image_link ); ?>"<?php echo $link_target; ?>>
					<?php endif; ?>
