...
/* -----------------------------------------------------------------------------
    ...
    NOTICE CATEGORIES WIDGET

----------------------------------------------------------------------------- */

if ( ! class_exists( 'Lsvr_Notice_Categories_Widget' ) ) {
class Lsvr_Notice_Categories_Widget extends WP_Widget {

    public function __construct() {
        $widget_ops = array( 'classname' => 'lsvr-notice-categories', 'description' => __( 'List notice categories.', 'lsvrtoolkit' ) );
        parent::__construct( 'lsvr_notice_categories_widget', __( 'LSVR Notice Categories', 'lsvrtoolkit' ), $widget_ops );
    }

    function form( $instance ) {

        $instance = wp_parse_args( (array) $instance, array( 'title' => __( 'Notice Categories', 'lsvrtoolkit' ), 'show_count' => 'on' ) );
