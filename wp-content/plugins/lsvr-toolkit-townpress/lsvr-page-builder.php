...
----------------------------------------------------------------------------- */
	...
	if ( ! function_exists( 'lsvr_vc_register_shortcodes' ) ) {
		function lsvr_vc_register_shortcodes() {
			...
			// DOCUMENTS
			require_once( 'vc-elements/documents.php' );

			// EVENTS
			require_once( 'vc-elements/events.php' );
			...
			// NOTICES
			require_once( 'vc-elements/notices.php' );
	...
	add_action( 'init', 'lsvr_vc_register_shortcodes' );
